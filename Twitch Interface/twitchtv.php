...
class TwitchTV {
  ...
  var $client_id = 'nmah9rw6kiapiocbpovc8pb7cb7a91i'; //change this value, should be your TwitchTV Application Client ID
  var $client_secret = "pyx63woy9hf1gdlk7j02efwpeq3ccoz"; //change this value, should be your TwitchTV Application Client Secret
  var $redirect_url = 'http://skole.dev/twitch/'; //change this value, should be your TwitchTV Application Rerdirect URL
